            ...
            <div className="w-1/2 md:w-full">
              <Image
                ...
                className="dark:animate-rubberBand w-full h-auto 
                  lg:hidden md:inline-block md:w-full dark:animate-rubberBandBounce"
                priority
            ...
            >
              ...
              >
                <Link
                  href="/nghi_cv.pdf"
                  target="_blank"
                  className="flex  items-center bg-dark text-light p-2.5 px-6 text-wrap
                  rounded-lg text-lg font-semibold 
                  hover:bg-light hover:text-dark
                  border-2 border-solid border-transparent
                  dark:bg-light dark:text-dark 
                  hover:dark:bg-dark hover:dark:text-light hover:dark:border-light
                  md:p-2 md:px-4 md:text-base group"
                  download={true}
                >
                  Resume
                  <ResumeIcon className={"w-10 ml-2 fill-light dark:fill-dark group-hover:fill-dark dark:group-hover:fill-light"} />
                </Link>
                <Link
