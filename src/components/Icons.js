...
export const ResumeIcon = ({ className, ...rest }) => (
    ...
    >
      <path
        d="M86.706 24.036H46.262c-6.943 0-12.592 5.648-12.592 12.592v70.744c0 6.943 5.648 12.592 12.592 12.592h51.559c6.943 0 12.592-5.648 12.592-12.592V50.533L86.706 24.036zm1.658 10.852 12.339 13.791H88.364V34.888zm9.457 79.076H46.262a6.6 6.6 0 0 1-6.592-6.592V36.628a6.6 6.6 0 0 1 6.592-6.592h36.102v24.643h22.049v52.693a6.6 6.6 0 0 1-6.592 6.592z"
        className="color000 svgShape"
      />
      <path
        d="M74.792 88.799V64.267h-6.001v24.532l-6.97-8.153-4.56 3.899 14.53 16.995 14.53-16.995-4.561-3.899z"
        className="color000 svgShape"
      />
    </svg>
);
